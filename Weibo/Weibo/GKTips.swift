...
final class GKTips: NSObject {
    ...
    override private init() {
        ...
        tipsViewlabel.textColor = UIColor.grayColor()
...
//        activityIndicatorView.color = UIColor.blackColor()
    ...
    func showTipsInMainThread(Text text:String) {
    ...
    func tipsViewTapHandle(sender: UITapGestureRecognizer) {
        
        disappearTipsInMainThread()
        
    }
    
    func disappearTipsInMainThread() {
    ...
    func showActivityIndicatorViewInMainThread(text: String!){
        ...
        let show:()->Void = {
            ...
            self.tipsViewlabel.textColor = UIColor.grayColor()
    ...
    func showActivityIndicatorViewInMainThread(viewController: UIViewController!, text: String!){
    ...
    func disappearActivityIndicatorViewInMainThread() {
    ...
    func activityIndicatorViewTapHandle(sender: UITapGestureRecognizer) {
